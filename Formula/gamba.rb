class Gamba < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/nurie05/gamba-tool/releases/download/v2.0.0/gamba-aarch64-apple-darwin.zip"
      sha256 "0019dfc4b32d63c1392aa264aed2253c1e0c2fb09216f8e2cc269bbfb8bb49b5" # arm64
    else
      url "https://github.com/nurie05/gamba-tool/releases/download/v2.0.0/gamba-x86_64-apple-darwin.zip"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/nurie05/gamba-tool/releases/download/v2.0.0/gamba-aarch64-unknown-linux-gnu.zip"
      sha256 "0019dfc4b32d63c1392aa264aed2253c1e0c2fb09216f8e2cc269bbfb8bb49b5" # linux-arm
    else
      url "https://github.com/nurie05/gamba-tool/releases/download/v2.0.0/gamba-x86_64-unknown-linux-gnu.zip"
